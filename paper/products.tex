...
% - APW: Can you put in explicit links to the iPython notebooks?
% - APW: Can you make the text larger in the Figure 1 legend?
...
% bugs
% ----
% - HOLY FUCK marginfix and marginpar are brittle. Some margin notes just disappear. OMG.
...
\renewcommand{\footnote}[1]{\refstepcounter{marginnote}\textsuperscript{\themarginnote}\marginpar{\raggedright\footnotesize\textsuperscript{\themarginnote}#1}}
...
in part at \textsl{Astro Hack Week 2016}, which was hosted at Berkeley
...
\end{equation}
This is the basis for the claim\footnote{A claim that perhaps hasn't been made forcefully
...
The table shown in Figure~\ref{fig:data1} contains $N=4$ data points,
...
\begin{table}[t!]
  \begin{center}
    \begin{tabular}{l r}
      ...
      \adjustbox{valign=t}{\includegraphics[width=0.6\textwidth]{exercise1.pdf}} \\
    \end{tabular}
...
The table shown in Figure~\ref{fig:data2} contains $N=4$ data points,
...
Generate 512 posterior samples in
the full set of parameters
$(\alpha, \beta, \gamma, \omega)$. The posterior
  posterior pdf over $\omega$ will be extremely multimodal. Don't fire up
  standard MCMC! Try using Rejection Sampling instead: Generate a
...
\begin{table}[t!]
  \begin{center}
    \begin{tabular}{l r}
      ...
      \adjustbox{valign=t}{\includegraphics[width=0.6\textwidth]{exercise2a.pdf}} \\
      \multicolumn{2}{l}{\includegraphics[width=0.9\textwidth]{exercise2b.pdf}}\\
    \end{tabular}

...
This magic also holds in many Gaussian-process contexts.
...
events
affected by the Higgs boson\footnote{See, for example, \todo{HOGG}{CITE here}};
...
variation of a star in response to an faint, orbiting companion\footnote{See,
  for an example in our own work \citep{Price-Whelan:2017}. That project and paper would have been
...
the matrix determinant lemma \citep[e.g.,][]{Wiki:MDL, Harville:2011}
...
called the Woodbury matrix identity; e.g.,][]{wiki:MIL, Harville:2011},

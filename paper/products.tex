...
\newcommand{\bP}{\ensuremath{\textrm{\ding{80}}}} % THIS IS HERE TO ANNOY DWH / you failed -- DWH
\newcommand{\bH}{\ensuremath{\textrm{\ding{114}}}} % THIS IS HERE TO ANNOY DWH / you failed -- DWH
...
the same for $\vb$. You will also need the determinant of the tensor.
To get the inverse and determinant
of the tensor $\tB$ stably and quickly, \emph{you might want to use
  the matrix inversion and determinant lemmas} (\ref{eq:invlemma})
and (\ref{eq:detlemma}) given above.
...
any heavy linear algebra; same for the determinants.
The lemmas save you the most time and precision when the parameter size $K$

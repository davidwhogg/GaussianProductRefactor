...
%   TODO: Say "marginalized likelihood", but if your parameters are all linear,
%         it's the "fully marginalized likelihood"
...
Here we deliver the details of this refactorization, and the closed-form
expressions.
We also explain how it connects to inferences that arise frequently in physics

...
\paragraph{Solution:}
\hogg{BL, please write stuff here!}

\hogg{BL, I think we should give the solution first, like we do in section 3, and then discuss how we found that solution using the canonical form. Does that work?}

...
\begin{table}[t!]
  ...
  \begin{center}
    ...
    \textsl{Left:} Simulated data used in Exercise 1
    ...
    \textsl{Right:} The solution to Exercise 1. The MAP parameter values were
    found using \equationname~\ref{eq:a} with the data shown in the included
    table.
    \label{fig:data1}}
  \end{center}
\end{table}

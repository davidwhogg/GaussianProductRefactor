...
$\tC\inv$---you might have to \emph{think about how you implement the
  ...
  or rotation or projection. Doing this correctly is beyond the scope for this \documentname.}.
...
\marginpar{\tfigurerule\\
  ...
  \caption{\textsl{Top:} Data used in Exercise~1
...
\marginpar{\tfigurerule\\
  ...
  \caption{\textsl{Top:} Data used in Exercise 2

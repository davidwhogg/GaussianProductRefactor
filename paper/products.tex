...
Bayes theorem is often written as a ratio of probability density functions (pdfs
in what follows), but it can also be written as a pdf factorization:
\begin{equation}
...
in the pedagogical literature\footnote{For example, \todo{HOGG}{CITE}, who claim that the
  ...
  function. It is the likelihood, not the prior pdf, that is fundamental to Bayesian
  inference.}
...
(although we don't think it often should be\footnote{\todo{HOGG}{WRITE STUFF ABOUT WHY YOU WANT TO PUBLISH LFs and marginalized LFs.}}); these expressions deliver the posterior

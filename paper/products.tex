...
% - HOGG: Are notes 12 and 20 redundant? If so, pick one and stick to
%   it. Note 20 could be modified to be a refer back to note 12.
...
% - APW: Can you make the text larger in the Figures?
...
% - APW: Cite Lomb-Scargle somewhere in Ex 2, perhaps? I'm not sure it's appropriate,
...
in the literature\footnote{It is very common for papers or projects with
  ...
  Your posterior pdf isn't all that useful to them!}

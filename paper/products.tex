...
\begin{equation}
\mbox{likelihood} \hoggquad p(\vy\given\vtheta,\bP) \hoggquad.
\end{equation}
...
function
\begin{equation}
\mbox{marginalized likelihood} \hoggquad p(\vy\given\bP) \hoggquad.
\end{equation}
That's good, but the marginalization comes at a cost:
We have to choose a prior
\begin{equation}
\mbox{prior on nuisance parameters} \hoggquad p(\vtheta\given\bP)
\end{equation}
on the nuisances.

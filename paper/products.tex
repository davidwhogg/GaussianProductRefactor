...
\newcommand{\tfigurerule}{\rule{0pt}{1ex}\\ \rule{\marginparwidth}{0.5pt}\\ \rule{0pt}{0.5ex}}
\newcommand{\bfigurerule}{\rule{0pt}{0.5ex}\\ \rule{\marginparwidth}{0.5pt}\\ \rule{0pt}{1ex}}
...
convergence of Markov Chain Monte Carlo\footnote{We have also written a tutorial
  on \acronym{MCMC} in this series \citep{Hogg:2018}.} (\acronym{MCMC})
...
\marginpar{\tfigurerule\\
  ...
  \parbox{\marginparwidth}{\raggedright\footnotesize\textbf{Figure 1}:
    \textsl{Top:} Simulated data used in Exercise~1
    (\href{https://raw.githubusercontent.com/davidwhogg/GaussianProductRefactor/master/notebooks/data1.csv}{link
    to data}). These data were generated with ``true'' parameters
...
\marginpar{\tfigurerule\\
  ...
  \parbox{\marginparwidth}{\raggedright\footnotesize\textbf{Figure 2}:
    \textsl{Top:} Simulated data used in Exercise 2

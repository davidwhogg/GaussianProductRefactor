...
\renewcommand{\footnote}[1]{\footnotemark\marginpar{\raggedright\footnotesize\textsuperscript{\thefootnote}{#1}}}
...
\begin{table}[t!]
  \begin{center}
    \begin{tabular}{l r}
      ...
      \multicolumn{2}{l}{\includegraphics[width=1\textwidth]{exercise2b.pdf}}\\
    \end{tabular}
